...
export const mockVisits: Visit[] = [
  {
    ...
    medicalHistory: {
      ...
      otherProblems: { acidity: true, diabetes: false, constipation: false, amebiasis: false, bp: true, other: 'Mild anxiety' },
  ...
  },
  {
    ...
    medicalHistory: {
      ...
      otherProblems: { acidity: true, diabetes: false, constipation: false, amebiasis: false, bp: false, other: '' },
  ...
  },
  {
    ...
    medicalHistory: {
      ...
      otherProblems: { acidity: false, diabetes: true, constipation: true, amebiasis: false, bp: false, other: '' },
